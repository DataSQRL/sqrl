 ...
 */
public class ExpressionOperatorTable extends ReflectiveSqlOperatorTable {

    private static ExpressionOperatorTable instance;

    public static synchronized ExpressionOperatorTable instance() {
        if (instance == null) {
            // Creates and initializes the standard operator table.
            // Uses two-phase construction, because we can't initialize the
            // table until the constructor of the sub-class has completed.
            instance = new ExpressionOperatorTable();
            instance.init();
        }
        return instance;
    }
    ...
    // AGGREGATE OPERATORS
    public static final SqlFunction SUM = function(SqlStdOperatorTable.SUM);

    private static SqlFunction function(SqlAggFunction agg) {
    ...
    public static final SqlFunction COUNT = function(SqlStdOperatorTable.COUNT);
