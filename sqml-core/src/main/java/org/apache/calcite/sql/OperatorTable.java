...
/**
 * SQRL operators. Resolved by calcite using reflection.
 */
public class OperatorTable extends ReflectiveSqlOperatorTable {

    private static OperatorTable instance;

    public static synchronized OperatorTable instance() {
        if (instance == null) {
