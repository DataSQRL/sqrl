 ...
 */
public class ContextAwareCalciteSchema extends org.apache.calcite.jdbc.CalciteSchema {
  /** Creates a SimpleCalciteSchema.
   *
   * <p>Use {@link CalciteSchema#createRootSchema(boolean)}
   * or {@link #add(String, Schema)}. */
  public ContextAwareCalciteSchema(@Nullable CalciteSchema parent, Schema schema, String name) {
    this(parent, schema, name, null, null, null, null, null, null, null, null);
  }

  private ContextAwareCalciteSchema(@Nullable CalciteSchema parent,
      Schema schema,
      String name,
  ...
  @Override public CalciteSchema add(String name, Schema schema) {
    final CalciteSchema calciteSchema =
        new ContextAwareCalciteSchema(this, schema, name);
  ...
  @Override protected @Nullable CalciteSchema getImplicitSubSchema(String schemaName,
    ...
    return new ContextAwareCalciteSchema(this, s, schemaName2);
  }
...
//    }
  ...
  @Override protected void addImplicitSubSchemaToBuilder(
      org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedMap.Builder<String, CalciteSchema> builder) {
    org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedMap<String, CalciteSchema> explicitSubSchemas = builder.build();
    for (String schemaName : schema.getSubSchemaNames()) {
      ...
      if (s != null) {
        CalciteSchema calciteSchema = new ContextAwareCalciteSchema(this, s, schemaName);
        builder.put(schemaName, calciteSchema);
      }
    }
  }

  @Override protected void addImplicitTableToBuilder(org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedSet.Builder<String> builder) {
    builder.addAll(schema.getTableNames());
  }

  @Override protected void addImplicitFunctionsToBuilder(
      org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableList.Builder<Function> builder,
  ...
  @Override protected void addImplicitFuncNamesToBuilder(
      org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedSet.Builder<String> builder) {
  ...
  @Override protected void addImplicitTablesBasedOnNullaryFunctionsToBuilder(
      org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedMap.Builder<String, Table> builder) {
    org.apache.flink.calcite.shaded.com.google.common.collect.ImmutableSortedMap<String, Table> explicitTables = builder.build();
  ...
  @Override protected CalciteSchema snapshot(@Nullable CalciteSchema parent,
    ...
    CalciteSchema snapshot = new ContextAwareCalciteSchema(parent,
