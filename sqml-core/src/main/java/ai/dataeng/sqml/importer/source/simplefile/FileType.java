...
import ai.dataeng.sqml.importer.source.util.SourceRecordCreator;
...
public enum FileType {
    ...
    abstract List<Map<String,Object>> getRecords(Path file);
    ...
    public static FileType getFileTypeFromExtension(String extension) {
        ...
        Preconditions.checkNotNull(ft,"Invalid extension: %s", extension);
        return ft;
    }
}
