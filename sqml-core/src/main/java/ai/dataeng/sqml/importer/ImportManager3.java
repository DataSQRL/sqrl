...
public class ImportManager3 {
    ...
    public ImportManager3(DatasetLookup datasetLookup) {
    ...
    public ImportSchema createImportSchema(ProcessBundle<SchemaConversionError> errors) {
    ...
    public void importDataset(@NonNull String datasetName, Optional<String> asName) {
        importDataset(toName(datasetName),asName.map(ImportManager3::toName));
    }
    ...
    public void importTable(@NonNull String datasetName,  @NonNull String tableName, Optional<String> asTableName) {
        importTable(toName(datasetName),toName(tableName),asTableName.map(ImportManager3::toName));
    }
