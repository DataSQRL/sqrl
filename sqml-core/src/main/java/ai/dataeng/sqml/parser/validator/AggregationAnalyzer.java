...
import static ai.dataeng.sqml.parser.validator.ScopeReferenceExtractor.getReferencesToScope;
import static ai.dataeng.sqml.parser.validator.ScopeReferenceExtractor.hasReferencesToScope;
import static ai.dataeng.sqml.parser.validator.ScopeReferenceExtractor.isFieldFromScope;
import static ai.dataeng.sqml.parser.validator.SemanticErrorCode.INVALID_PROCEDURE_ARGUMENTS;
import static ai.dataeng.sqml.parser.validator.SemanticErrorCode.MUST_BE_AGGREGATE_OR_GROUP_BY;
import static ai.dataeng.sqml.parser.validator.SemanticErrorCode.REFERENCE_TO_OUTPUT_ATTRIBUTE_WITHIN_ORDER_BY_GROUPING;
...
//    private final FunctionResolution functionResolution;
    ...
    private AggregationAnalyzer(List<Expression> groupByExpressions, Scope sourceScope, Optional<Scope> orderByScope, StatementAnalysis analysis)
    {
