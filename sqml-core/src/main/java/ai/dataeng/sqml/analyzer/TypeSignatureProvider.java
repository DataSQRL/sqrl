...
public class TypeSignatureProvider {
  ...
  public TypeSignatureProvider(Function<List<Type>, TypeSignature> typeSignatureResolver) {
    ...
    this.typeSignatureResolver = requireNonNull(typeSignatureResolver,
        "typeSignatureResolver is null");
  }
  ...
  public static List<TypeSignatureProvider> fromTypeSignatures(
