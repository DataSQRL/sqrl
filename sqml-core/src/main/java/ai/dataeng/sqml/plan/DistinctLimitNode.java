...
public final class DistinctLimitNode
  ...
  public DistinctLimitNode(
    ...
    checkArgument(!hashVariable.isPresent() || !distinctVariables.contains(hashVariable.get()),
        "distinctVariables should not contain hash variable");
  }
  ...
  public PlanNode replaceChildren(List<PlanNode> newChildren) {
    ...
    return new DistinctLimitNode(getId(), newChildren.get(0), limit, partial, distinctVariables,
        hashVariable);
  }
}
