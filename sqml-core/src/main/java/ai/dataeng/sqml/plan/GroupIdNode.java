...
public class GroupIdNode
  ...
  public GroupIdNode(
    ...
    checkArgument(
        Sets.intersection(groupingColumns.keySet(), ImmutableSet.copyOf(aggregationArguments))
            .isEmpty(), "aggregation columns and grouping set columns must be a disjoint set");
  }
  ...
  public int hashCode() {
    return Objects
        .hash(source, groupingSets, groupingColumns, aggregationArguments, groupIdVariable);
  }
}
