...
public final class MarkDistinctNode
  ...
  public MarkDistinctNode(@JsonProperty("id") PlanNodeId id,
    ...
    List<VariableReferenceExpression> variableReferenceExpressions = new ArrayList<>(
  ...
  public PlanNode replaceChildren(List<PlanNode> newChildren) {
    ...
    return new MarkDistinctNode(getId(), newChildren.get(0), markerVariable, distinctVariables,
        hashVariable);
  }
}
