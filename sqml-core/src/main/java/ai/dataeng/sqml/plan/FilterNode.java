...
public final class FilterNode
  ...
  /**
   * Get the predicate (a RowExpression of boolean type) of the FilterNode. It serves as the
   * criteria to determine whether the incoming rows should be filtered out or not.
   */
  @JsonProperty
