...
/**
 * The basic component of a Presto IR (logic plan). An IR is a tree structure with each PlanNode
...
public abstract class PlanNode {
  ...
  /**
   * The output from the upstream PlanNodes. It should serve as the input for the current PlanNode.
   */
