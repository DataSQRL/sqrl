 ...
 */
package ai.dataeng.sqml.common;
...
import static ai.dataeng.sqml.sql.tree.ComparisonExpression.Operator.IS_DISTINCT_FROM;
import static java.util.Objects.requireNonNull;
import static java.util.stream.Collectors.toList;

import ai.dataeng.sqml.planner.ExpressionDeterminismEvaluator;
...
public final class ExpressionUtils {
  ...
  public static List<Expression> extractPredicates(LogicalBinaryExpression.Operator operator,
  ...
  public static Expression binaryExpression(LogicalBinaryExpression.Operator operator,
  ...
  public static Expression combinePredicates(LogicalBinaryExpression.Operator operator,
  ...
  public static Expression combineDisjunctsWithDefault(Collection<Expression> expressions,
  ...
  public static Expression normalize(Expression expression) {
    if (expression instanceof NotExpression) {
      ...
      if (not.getValue() instanceof ComparisonExpression
          && ((ComparisonExpression) not.getValue()).getOperator() != IS_DISTINCT_FROM) {
        ComparisonExpression comparison = (ComparisonExpression) not.getValue();
        return new ComparisonExpression(comparison.getOperator().negate(), comparison.getLeft(),
            comparison.getRight());
      }
