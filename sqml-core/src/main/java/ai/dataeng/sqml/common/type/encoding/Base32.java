...
package ai.dataeng.sqml.common.type.encoding;

/**
 * Provides Base32 encoding and decoding as defined by <a href="http://www.ietf.org/rfc/rfc4648.txt">RFC
 * 4648</a>.
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>Whether to use the "base32hex" variant instead of the default "encoding"</li>
...
public class Base32
   ...
   * </p>
   *
   * @param lineLength    Each line of encoded data will be at most of the given length (rounded
   *                      down to nearest multiple of 8). If lineLength &lt;= 0, then the output
   *                      will not be divided into lines (chunks). Ignored when decoding.
   ...
   *                      will not be divided into lines (chunks). Ignored when decoding.
   * @param lineSeparator Each line of encoded data will end with this sequence of bytes.
   * @param useHex        if {@code true}, then use Base32 Hex alphabet, otherwise use Base32
   *                      alphabet
   * @throws IllegalArgumentException The provided lineSeparator included some Base32 characters.
   *                                  That's not going to work! Or the lineLength &gt; 0 and
   ...
   *                <p>
   *                Output is written to {@link Context#buffer} as 8-bit octets, using {@link
