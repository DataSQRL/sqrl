...
public final class Varchars {
  ...
  public static Slice truncateToLength(Slice slice, Type type) {
    ...
    return truncateToLength(slice, (VarcharType) type);
  }

  public static Slice truncateToLength(Slice slice,
  ...
  /**
   * Get the byte count of a given {@param slice} with in range {@param offset} to {@param offset} +
   * {@param length} for at most {@param codePointCount} many code points
   */
