 ...
 * <p>
 * Fields are resolved by {@link TranslationMap} within local scopes hierarchy. Indexes of resolved
 * parent scope fields start from "total number of child scope fields". For instance if a child
 * scope has n fields, then first parent scope field will have index n.
 */
