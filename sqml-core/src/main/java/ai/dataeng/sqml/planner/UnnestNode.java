...
public class UnnestNode
  ...
  public UnnestNode(
    ...
    this.replicateVariables = ImmutableList
        .copyOf(requireNonNull(replicateVariables, "replicateVariables is null"));
    checkArgument(source.getOutputVariables().containsAll(replicateVariables),
    ...
    ImmutableMap.Builder<VariableReferenceExpression, List<VariableReferenceExpression>> builder = ImmutableMap
        .builder();
    for (Map.Entry<VariableReferenceExpression, List<VariableReferenceExpression>> entry : unnestVariables
        .entrySet()) {
  ...
  public List<VariableReferenceExpression> getOutputVariables() {
    ImmutableList.Builder<VariableReferenceExpression> outputSymbolsBuilder = ImmutableList
  ...
  public PlanNode replaceChildren(List<PlanNode> newChildren) {
    return new UnnestNode(getId(), Iterables.getOnlyElement(newChildren), replicateVariables,
        unnestVariables, ordinalityVariable);
  }
