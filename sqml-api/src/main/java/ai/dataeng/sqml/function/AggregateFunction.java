...
public abstract class AggregateFunction<T, ACC> extends ImperativeAggregateFunction<T, ACC> {
    ...
    public abstract void accumulate(ACC accumulator, T... input);
    public abstract void retract(ACC accumulator, T... input);
    public abstract void merge(ACC accumulator, java.lang.Iterable<ACC> iterable);
}
