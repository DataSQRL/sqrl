...
public interface CallContext {
     ...
     */
    List<Type> getArgumentDataTypes();
     ...
     * ArgumentTypeStrategy#inferArgumentType(org.apache.flink.table.types.inference.CallContext, int, boolean)} of a wrapping call (if
     ...
     */
    Optional<Type> getOutputDataType();
//
//    /**
