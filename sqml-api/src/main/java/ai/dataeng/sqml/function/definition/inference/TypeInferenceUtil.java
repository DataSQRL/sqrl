...
//        final List<Type> actualTypes = callContext.getArgumentDataTypes();
//
//        typeInference
//                .getTypedArguments()
//                .ifPresent(
...
//        final List<Type> expectedTypes = adaptedCallContext.getArgumentDataTypes();
...
//        final Optional<Type> potentialOutputType = outputTypeStrategy.inferType(callContext);
...
//        }
//
//        Optional<Type> inferOutputType(DataTypeFactory typeFactory);
//    }
//
//    /**
...
//
//        private final List<Type> expectedArgumentTypes;
//
...
//
//        public Result(
//                List<Type> expectedArgumentTypes,
...
//        }
//
//        public List<Type> getExpectedArgumentTypes() {
//            return expectedArgumentTypes;
//        }
//
//        public Optional<Type> getAccumulatorDataType() {
...
//        final Optional<List<Type>> optionalDataTypes = typeInference.getTypedArguments();
//        final int count =
//                Math.max(
...
//                        .map(org.apache.flink.table.types.inference.TypeInferenceUtil::formatArgument)
//                        .collect(Collectors.joining(", "));
//        return String.format("%s(%s)", name, arguments);
//    }
//
...
//
//        final List<Type> inferredDataTypes =
//                typeInference
//                        .getInputTypeStrategy()
...
//            return outputType;
//        }
//        final Optional<Type> potentialAccumulatorType =
