...
public class SqrlEnvironment {
  ...
  SqrlSchemaResolver schemaResolver;
...
//    schema.add("default_schema", new ReflectiveSchema(new C360()));
  ...
  public SqrlTable2 addColumn(SqrlTable2 table, Name name, String sql) {
    return null;
  }

  public void addRelationshipToSchema(SqrlTable2 from, Name name, SqrlTable2 to) {
