...
import static ai.dataeng.sqml.physical.sql.util.DatabaseUtil.sqlName;
...
public class CreateTableBuilder extends TableBuilder {
    ...
    public CreateTableBuilder addColumns(LogicalPlan.Column[] columns) {
        for (LogicalPlan.Column col : columns) addColumn(col);
        return this;
    }

    public CreateTableBuilder addColumn(LogicalPlan.Column column) {
