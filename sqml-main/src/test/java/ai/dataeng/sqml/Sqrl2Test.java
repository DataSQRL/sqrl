...
//import ai.dataeng.sqml.importer.ImportManager2;
...
//import ai.dataeng.sqml.execution.flink.process.SqrlSinkBuilder;
...
//
//    Environment environment = new Environment(new ImportManager2(importStub), env, new SqrlSchemaResolver());
...
//    );
//
//    GraphQLSchema schema = new GraphqlSchemaBuilder(Map.of(), plan.getSchema(),
