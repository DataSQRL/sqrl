...
import static com.datasqrl.server.graphql.TypeDefinitionRegistryUtil.getMutationTypeName;
import static com.datasqrl.server.graphql.TypeDefinitionRegistryUtil.getSubscriptionTypeName;

import com.datasqrl.server.MutationConfiguration;
import com.datasqrl.server.ServerContext;
import com.datasqrl.server.SubscriptionConfiguration;
...
import com.datasqrl.server.graphql.RootGraphQLModel.QueryBaseVisitor;
import com.datasqrl.server.graphql.RootGraphQLModel.QueryCoordVisitor;
...
import com.datasqrl.server.graphql.RootGraphQLModel.ResolvedQueryVisitor;
...
public class GraphQLEngineBuilder
    implements RootVisitor<GraphQL.Builder, ServerContext>,
        QueryCoordVisitor<DataFetcher<?>, ServerContext>,
        SchemaVisitor<TypeDefinitionRegistry, Object>,
        QueryBaseVisitor<ResolvedQuery, ServerContext>,
  ...
  @Override
  public GraphQL.Builder visitRoot(RootGraphQLModel root, ServerContext context) {
  ...
  @Override
  public ResolvedQuery visitSqlQuery(SqlQuery query, ServerContext context) {
  ...
  @Override
  public DataFetcher<?> visitArgumentLookup(ArgumentLookupQueryCoords coords, ServerContext ctx) {
