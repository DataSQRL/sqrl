...
public class ServerConfigUtil {
  ...
  public static ServerConfig mergeConfigs(
    ...
    var config = ((ObjectNode) JsonUtils.MAPPER.valueToTree(serverConfig)).deepCopy();
    JsonUtils.merge(config, JsonUtils.MAPPER.valueToTree(configOverrides));
    return JsonUtils.MAPPER.treeToValue(config, ServerConfig.class).validated();
  }
  ...
  public static ServerConfig fromConfigMap(Map<String, Object> configMap) {
    return JsonUtils.MAPPER.convertValue(configMap, ServerConfig.class).validated();
  }
