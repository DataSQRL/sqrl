...
class WriteIT {
  ...
  private Map<String, String> getKafkaConfig() {
    ...
    props.put(KEY_SERIALIZER_CLASS_CONFIG, "com.datasqrl.server.kafka.JsonSerializer");
    props.put(VALUE_SERIALIZER_CLASS_CONFIG, "com.datasqrl.server.kafka.JsonSerializer");
        ...
        model
            .accept(
                ...
                new VertxServerContext(
                    new VertxJdbcClient(Map.of(DatabaseType.POSTGRES, client)),
                    null,
                    null,
