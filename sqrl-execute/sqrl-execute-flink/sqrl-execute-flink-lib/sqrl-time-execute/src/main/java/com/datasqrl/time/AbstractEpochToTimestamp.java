...
//  public static final Instant DEFAULT_DOC_TIMESTAMP = Instant.parse("2023-03-12T18:23:34.083Z");
  ...
  public TypeInference getTypeInference(DataTypeFactory typeFactory) {
    return FlinkTypeUtil.basicNullInference(DataTypes.TIMESTAMP_WITH_LOCAL_TIME_ZONE(3),
        DataTypes.BIGINT());
  }
//
//  @Override
...
//        "Converts the epoch timestamp in %s to the corresponding timestamp.<br />E.g. `%s` returns the timestamp `%s`",
