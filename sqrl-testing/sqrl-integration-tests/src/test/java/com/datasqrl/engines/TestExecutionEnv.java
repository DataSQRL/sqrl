...
public class TestExecutionEnv implements TestEngineVisitor<Void, TestEnvContext> {
  ...
  public Void visit(PostgresTestEngine engine, TestEnvContext context) {
    ...
    String url = context.env.get("SQRL_RUN_POSTGRES_JDBC_URL");
    String username = context.env.get("SQRL_RUN_POSTGRES_USERNAME");
    String password = context.env.get("SQRL_RUN_POSTGRES_PASSWORD");
