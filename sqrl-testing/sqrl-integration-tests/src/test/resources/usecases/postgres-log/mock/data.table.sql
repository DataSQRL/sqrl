CREATE TABLE Data (
    ...
    `TIMESTAMP` AS COALESCE(TO_TIMESTAMP_LTZ(`EPOCH_TIMESTAMP`, 0), TIMESTAMP '1970-01-01 00:00:00.000'),
    `event_time` AS COALESCE(TO_TIMESTAMP_LTZ(`EPOCH_TIMESTAMP`, 0), TIMESTAMP '1970-01-01 00:00:00.000'),
