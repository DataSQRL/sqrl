...
public class StdTimeLibraryTest {
  ...
  public void testTimeBucket() {
    ...
    Assertions.assertEquals(t("2023-03-08T20:29:59.999999999Z"), END_OF_HOUR.eval(TIME1, 4L, 30L));
    Assertions.assertEquals(t("2023-03-08T23:59:59.999999999Z"), END_OF_DAY.eval(TIME1));
    Assertions.assertEquals(t("2023-03-11T23:59:59.999999999Z"), END_OF_DAY.eval(TIME1, 10L));
    Assertions.assertEquals(t("2023-03-09T02:59:59.999999999Z"), END_OF_DAY.eval(TIME1, 1L, 3L));
    Assertions.assertEquals(t("2023-01-01T01:59:59.999999999Z"), END_OF_DAY.eval(TIME4, 10L, 2L));
    Assertions.assertEquals(t("2023-03-12T23:59:59.999999999Z"), END_OF_WEEK.eval(TIME1));
    Assertions.assertEquals(t("2023-03-12T23:59:59.999999999Z"), END_OF_WEEK.eval(TIME2));
    Assertions.assertEquals(t("2023-03-12T23:59:59.999999999Z"), END_OF_WEEK.eval(TIME3));
    Assertions.assertEquals(t("2023-03-13T23:59:59.999999999Z"), END_OF_WEEK.eval(TIME1, 1L, 1L));
    Assertions.assertEquals(t("2023-03-08T23:59:59.999999999Z"), END_OF_WEEK.eval(TIME1, 1L, 3L));
    Assertions.assertEquals(t("2023-03-31T23:59:59.999999999Z"), END_OF_MONTH.eval(TIME1));
    Assertions.assertEquals(t("2023-04-05T23:59:59.999999999Z"), END_OF_MONTH.eval(TIME1, 1L, 5L));
    Assertions.assertEquals(t("2023-03-10T23:59:59.999999999Z"), END_OF_MONTH.eval(TIME1, 1L, 10L));
    Assertions.assertEquals(t("2023-12-31T23:59:59.999999999Z"), END_OF_YEAR.eval(TIME1));
    Assertions.assertEquals(t("2024-12-31T23:59:59.999999999Z"), END_OF_YEAR.eval(TIME1, 5L));
    Assertions.assertEquals(t("2030-01-20T23:59:59.999999999Z"), END_OF_YEAR.eval(TIME1, 10L, 20L));
  }
