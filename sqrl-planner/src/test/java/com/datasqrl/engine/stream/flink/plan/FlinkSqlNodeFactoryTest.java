...
public class FlinkSqlNodeFactoryTest {
  ...
  void testCreateFunction() {
    ...
    var createFunction = FlinkSqlNodeFactory.createFunction(functionName, className);

    var sql = unparse(createFunction);
    var expectedSql = "CREATE TEMPORARY FUNCTION IF NOT EXISTS `my_udf` AS 'com.example.MyUDF' LANGUAGE JAVA";
    assertEquals(expectedSql, sql.trim());
  }
  ...
  void testCreateTable() {
    ...
    FlinkSqlNodeFactory.MetadataExpressionParser expressionParser = FlinkSqlNodeFactory::identifier;
