...
//              createTableSource(clazz, DATASET_NAME, "ecommerce-data"), tableFactory, moduleLoader);
...
//        .initializeSource(NamePath.of(moduleName),
...
//    for (Class clazz : dataByClass.keySet()) {
//      TableSource table = createTableSource(clazz, null, "ecommerce-data");
//      TableWriter writer = new TableWriter();
//      writer.writeToFile(Path.of("/Users/matthias/git/sqml/sqrl-testing/sqrl-integration-tests/src/test/resources/dagplanner/ecommerce/"),table);
//    };
//  }
//
//
