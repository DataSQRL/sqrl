...
public class SubstringSqlTranslation extends DuckDbSqlTranslation {

  public SubstringSqlTranslation() {
    super(BuiltInFunctionDefinitions.SUBSTRING);
  }
  ...
  public void unparse(SqlCall call, SqlWriter writer, int leftPrec, int rightPrec) {
    ...
    CalciteFunctionUtil.writeFunction("substring", writer, operands);
  }
