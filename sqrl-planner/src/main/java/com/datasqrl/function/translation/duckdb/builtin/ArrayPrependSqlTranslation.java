...
public class ArrayPrependSqlTranslation extends DuckDbSqlTranslation {

  public ArrayPrependSqlTranslation() {
    super(CalciteFunctionUtil.lightweightOp("ARRAY_PREPEND"));
  }
