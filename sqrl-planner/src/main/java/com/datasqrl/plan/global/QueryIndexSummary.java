...
public class QueryIndexSummary {
  ...
  @Include PhysicalRelationalTable table;
  ...
  public static Optional<QueryIndexSummary> ofFilter(
      @NonNull PhysicalRelationalTable table, RexNode filter, SqrlRexUtil rexUtil) {
  ...
  public static Optional<QueryIndexSummary> ofSort(
      @NonNull PhysicalRelationalTable table, RexNode node) {
  ...
  public static Optional<QueryIndexSummary> ofSort(
      @NonNull PhysicalRelationalTable table, int columnIndex) {
    return Optional.of(
  ...
  private static class IndexableFinder extends RexShuttle {
    ...
    private static Optional<IndexableFunctionCall> resolveIndexFunctionCall(
      ...
      if (columnIndexes.isEmpty() || columnIndexes.size() > operandSelector.maxNumberOfColumns())
        return Optional.empty();
