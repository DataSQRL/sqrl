...
/**
 * For CREATE TABLE {@link JdbcStatement} which track additional information about the physical
 * table and create the SQL string on demand so it can be optimized.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonPropertyOrder({"name", "type", "sql", "fields"})
@Value
@AllArgsConstructor
public class CreateTableJdbcStatement implements JdbcStatement {
  ...
  public CreateTableJdbcStatement updatePrimaryKey(List<String> newPk) {
    Preconditions.checkArgument(
        Set.copyOf(primaryKey).equals(Set.copyOf(newPk)),
  ...
  public interface CreateTableDdlFactory {
    ...
    String createTableDdl(CreateTableJdbcStatement statement);
  }
