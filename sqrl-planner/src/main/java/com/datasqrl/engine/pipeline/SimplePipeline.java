...
public class SimplePipeline implements ExecutionPipeline {
  ...
  private static List<EngineStage> getStage(Type engineType, Map<String, ExecutionEngine> engines) {
  ...
  private static Optional<EngineStage> getSingleStage(
      Type engineType, Map<String, ExecutionEngine> engines) {
    ...
    throw new IllegalArgumentException(
        String.format(
            "Expected a single %s engine but found multiple: %s", engineType, engineList));
  }
