...
public class Orders extends AbstractQueryableTable {
  private final List<Student> students;

  public Orders() {
    this(Arrays.asList(new Orders.Student("1", 10),
        new Orders.Student("2", 20),
        new Orders.Student("3", 30),
        new Orders.Student("4", 40),
        new Orders.Student("5", 50)
        ));
  }

  public Orders(List<Student> students) {
    super(Object[].class);
