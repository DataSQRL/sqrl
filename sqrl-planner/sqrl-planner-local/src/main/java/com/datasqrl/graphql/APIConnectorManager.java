...
@Getter
public class APIConnectorManager {
  ...
  @Inject
  public APIConnectorManager(ExecutionPipeline pipeline,
  ...
  private APIConnectorManager() {
    this.errors = ErrorCollector.root();
    this.moduleLoader = null;
    this.logEngine = Optional.empty();
    this.typeFactory = null;
  }

  public static APIConnectorManager testInstance() {
    return new APIConnectorManager();
  }
