...
/**
 * A {@link TableSource} defines an input source to be imported into an SQRL script. A {@link
 * TableSource} is comprised of records and is the smallest unit of data that one can refer to
 * within an SQRL script.
 */
@Getter
public class TableSource extends TableInput {

  public TableSource(TableConfig configuration, NamePath path, Name name, TableSchema schema) {
