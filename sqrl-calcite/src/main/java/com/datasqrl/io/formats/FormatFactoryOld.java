...
public interface FormatFactoryOld extends Serializable {
...
//   * @param inputPreview
//   */
  default void inferConfig(@NonNull SqrlConfig config, @NonNull Object inputPreview) {
  ...
  static FormatFactoryOld fromConfig(@NonNull SqrlConfig config) {
    return ServiceLoaderDiscovery.get(FormatFactoryOld.class, FormatFactoryOld::getName,
