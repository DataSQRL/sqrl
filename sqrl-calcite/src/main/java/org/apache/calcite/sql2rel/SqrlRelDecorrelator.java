...
public class SqrlRelDecorrelator extends RelDecorrelator {
  ...
  protected SqrlRelDecorrelator(CorelMap cm, Context context, RelBuilder relBuilder) {
  ...
  public static RelNode decorrelateQuery(RelNode rootRel, RelBuilder relBuilder) {
    ...
    final RelDecorrelator decorrelator =
        new SqrlRelDecorrelator(corelMap, cluster.getPlanner().getContext(), relBuilder);
