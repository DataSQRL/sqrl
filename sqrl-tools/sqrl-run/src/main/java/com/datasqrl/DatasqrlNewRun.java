...
import com.datasqrl.DatasqrlRun.ModelContainer;
...
public class DatasqrlNewRun {
  ...
  public static void main(String[] args) {
    DatasqrlNewRun run = new DatasqrlNewRun();
    run.run(true);
  }

  public DatasqrlNewRun() {
    this.env = System.getenv();
    //todo: Data_dir, kafka brokers
  }

  public DatasqrlNewRun(Path path, Map<String, String> env) {
