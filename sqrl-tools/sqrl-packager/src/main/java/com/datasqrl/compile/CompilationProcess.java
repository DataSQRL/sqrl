...
public class CompilationProcess {
  ...
  private final CreateDatabaseQueries createDatabaseQueries; // 1.4. TRANSPILER: Based on the logicalPlan (calcite schema) keep track of the APIQueries (multi-purpose wrapper of query parameters with calcite node) for the table functions
