...
public class LogicalBinaryExpression
  ...
  public LogicalBinaryExpression(NodeLocation location, Operator operator, Expression left,
      Expression right) {
    this(Optional.of(location), operator, left, right);
  }

  private LogicalBinaryExpression(Optional<NodeLocation> location, Operator operator,
