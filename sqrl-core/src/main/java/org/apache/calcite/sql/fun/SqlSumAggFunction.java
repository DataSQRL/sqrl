 ...
 * is the same type.
 */
public class SqlSumAggFunction extends SqlAggFunction implements ConvertableFunction {
  ...
  public Optional<SqlFunction> convertToInlineAgg() {
    return Optional.of(new SqlSumInlineAggFunction(type,
        this,
        this.getName(),
        this.getSqlIdentifier(),
        this.getKind(),
        this.getReturnTypeInference(),
        this.getOperandTypeInference(),
        this.getOperandTypeChecker(),
