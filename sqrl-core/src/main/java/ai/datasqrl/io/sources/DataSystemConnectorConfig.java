...
@JsonSubTypes({@JsonSubTypes.Type(value = DirectoryDataSystem.Connector.class, name = DirectoryDataSystemConfig.SOURCE_TYPE),
    @JsonSubTypes.Type(value = KafkaDataSystem.Connector.class, name = KafkaDataSystemConfig.SOURCE_TYPE),})
