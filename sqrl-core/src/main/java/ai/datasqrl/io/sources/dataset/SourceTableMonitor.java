 ...
 * SourceTable} to compile statistics on the data.
 * <p>
 * A {@link SourceTableMonitor} implementation keeps track of the status of the monitoring,
 * continues monitoring in case of recoverable failure, and persists the job id to stop monitoring
 * when needed.
 */
