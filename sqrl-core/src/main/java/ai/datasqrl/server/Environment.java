...
import ai.datasqrl.materialize.FlinkPipelineGenerator;
import ai.datasqrl.sql.ddl.SqlDDLGenerator;
import ai.datasqrl.execute.SqrlExecutor;
...
//              "Encountered error while compiling script: %s",e));
  ...
  public void compile(ScriptDeployment submission) throws Exception {
