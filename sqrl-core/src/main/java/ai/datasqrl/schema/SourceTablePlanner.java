...
import static ai.datasqrl.parse.tree.name.Name.PARENT_RELATIONSHIP;
...
@AllArgsConstructor
public class SourceTablePlanner {
...
//    setParentChildRelation(rootTable);
  ...
  private Table tableConversion(RelationType<FlexibleDatasetSchema.FlexibleField> relation,
    ...
    Column ingestTime = Column.createTemp(Name.system("_ingest_time"), DateTimeType.INSTANCE, table, 0);
