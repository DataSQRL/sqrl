...
public class FlinkUtilities {
  ...
  public static final ObjectArrayTypeInfo INSTANT_ARRAY_TYPE_INFO = ObjectArrayTypeInfo.getInfoFor(
      Instant[].class, BasicTypeInfo.INSTANT_TYPE_INFO);
  ...
  public static TypeInformation getFlinkTypeInfo(BasicType datatype, boolean isArray) {
    if (datatype instanceof StringType) {
      ...
      if (isArray) {
        return INSTANT_ARRAY_TYPE_INFO;
      } else {
