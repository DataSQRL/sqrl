...
public class RoundToSecondFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            RoundToSecond.class, "roundToSecond", Instant.class));

    public RoundToSecondFunction() {
        super(
                new SqlIdentifier("ROUND_TO_SECOND", SqlParserPos.ZERO),
                SqlKind.OTHER,
