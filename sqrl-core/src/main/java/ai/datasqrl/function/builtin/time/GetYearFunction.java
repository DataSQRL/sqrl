...
public class GetYearFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetYear.class, "getYear", Instant.class));

    public GetYearFunction() {
        super(
                new SqlIdentifier("GET_YEAR", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
