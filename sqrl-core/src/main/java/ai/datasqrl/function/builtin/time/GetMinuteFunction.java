...
public class GetMinuteFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetMinute.class, "getMinute", Instant.class));

    public GetMinuteFunction() {
        super(
                new SqlIdentifier("GET_MINUTE", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
