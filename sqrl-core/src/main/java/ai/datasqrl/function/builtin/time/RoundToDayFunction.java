...
public class RoundToDayFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            RoundToDay.class, "roundToDay", Instant.class));

    public RoundToDayFunction() {
        super(
                new SqlIdentifier("ROUND_TO_DAY", SqlParserPos.ZERO),
                SqlKind.OTHER,
