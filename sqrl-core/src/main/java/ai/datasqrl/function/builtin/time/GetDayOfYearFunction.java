...
public class GetDayOfYearFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetDayOfYear.class, "getDayOfYear", Instant.class));

    public GetDayOfYearFunction() {
        super(
                new SqlIdentifier("GET_DAY_OF_YEAR", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
