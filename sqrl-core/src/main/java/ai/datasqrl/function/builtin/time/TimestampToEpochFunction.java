...
public class TimestampToEpochFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            TimestampToEpoch.class, "timestampToEpoch", Instant.class));
