...
public class GetDayOfWeekFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetDayOfWeek.class, "getDayOfWeek", Instant.class));

    public GetDayOfWeekFunction() {
        super(
                new SqlIdentifier("GET_DAY_OF_WEEK", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
