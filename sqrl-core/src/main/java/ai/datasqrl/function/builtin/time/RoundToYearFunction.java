...
public class RoundToYearFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            RoundToYear.class, "roundToYear", Instant.class));

    public RoundToYearFunction() {
        super(
                new SqlIdentifier("ROUND_TO_YEAR", SqlParserPos.ZERO),
                SqlKind.OTHER,
