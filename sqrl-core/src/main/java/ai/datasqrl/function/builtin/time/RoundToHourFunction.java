...
public class RoundToHourFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            RoundToHour.class, "roundToHour", Instant.class));

    public RoundToHourFunction() {
        super(
                new SqlIdentifier("ROUND_TO_HOUR", SqlParserPos.ZERO),
                SqlKind.OTHER,
