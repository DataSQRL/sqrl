...
public class GetHourFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetHour.class, "getHour", Instant.class));

    public GetHourFunction() {
        super(
                new SqlIdentifier("GET_HOUR", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
