...
public class GetSecondFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetSecond.class, "getSecond", Instant.class));

    public GetSecondFunction() {
        super(
                new SqlIdentifier("GET_SECOND", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
