...
public class GetMonthFunction extends SqlUserDefinedFunction implements SqrlAwareFunction {

    static final ScalarFunction fnc = ScalarFunctionImpl.create(Types.lookupMethod(
            GetMonth.class, "getMonth", Instant.class));

    public GetMonthFunction() {
        super(
                new SqlIdentifier("GET_MONTH", SqlParserPos.ZERO),
                SqlKind.OTHER,
                ReturnTypes.INTEGER,
