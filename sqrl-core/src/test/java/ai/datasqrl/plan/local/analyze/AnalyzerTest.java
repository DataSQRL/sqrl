...
class AnalyzerTest extends AbstractSQRLIT {
  ...
  public void expressionTest() {
    ...
    Optional<Table> productTable = analysis.getSchema().getTable(Name.system("Product"));
  ...
  public void selectStarQueryTest() {
    ...
    Optional<Table> productTable = analysis.getSchema().getTable(Name.system("ProductCopy"));
    Assertions.assertTrue(productTable.isPresent());
  ...
  public void fullyQualifiedQueryName() {
    ...
    Optional<Table> productTable = analysis.getSchema().getTable(Name.system("Product2"));
    Assertions.assertTrue(productTable.isPresent());
  }
...
//    Assertions.assertTrue(rel.getOrders().isPresent());
  ...
  public void tablePathTest() {
    ...
    Optional<Table> productTable = analysis.getSchema().getTable(Name.system("NewProduct"));
    Assertions.assertTrue(productTable.isPresent());
  }
