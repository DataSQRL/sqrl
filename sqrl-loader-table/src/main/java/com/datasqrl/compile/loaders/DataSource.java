...
public class DataSource {
  ...
  protected static<T extends AbstractExternalTable> Optional<T> readTable(Path rootDir, NamePath fullPath,
  ...
  public static class Exporter extends DataSource implements com.datasqrl.compile.loaders.Exporter {
    ...
    public Optional<TableSink> export(LoaderContext ctx, NamePath fullPath) {
      Optional<TableSink> sink = readTable(ctx.getPackagePath(), fullPath, ctx.getErrorCollector(), TableSink.class, deserialize);
      if (sink.isEmpty()) {
